...
from PyQt5.QtWidgets import QWidget, QMainWindow, QPushButton, QHBoxLayout, QVBoxLayout, QSlider, QLabel, \
    QTreeWidget, QTreeWidgetItem, QFrame, QAction, QFileDialog, QAbstractItemView
import Rating, Media
import constants
import details
...
class App(QMainWindow):
    ...
    def addControls(self):
        ...
        QTreeWidgetItem(self.tree, ['jim/midis/Hit_the_Road_Jack.mid', '2', 'Example'])
        QTreeWidgetItem(self.tree, ['jim/midis/Holiday.mid', '4', 'Example'])
        # create Tune buttun
